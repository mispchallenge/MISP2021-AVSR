...
# video data preparation 
    ...
    #1.created audio dir 2.create roi.scp for roilist 2.fix audio and video dir make sure they have same uttids
    for setclass in train dev eval; do
        local/extract_mid_video_roi.sh --nj 15 --stage ${_stage} ${setclass} $_roi_dir/${setclass}/middle || exit 1;
    done 
    fi
