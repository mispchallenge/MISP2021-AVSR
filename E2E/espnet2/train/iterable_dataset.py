...
DATA_TYPES = {
    ...
    "video":video_load,
    "video_no_interpolation":nointerpolation_video_load,
    "npy": np.load,
    ...
    def __iter__(self) -> Iterator[Tuple[Union[str, int], Dict[str, np.ndarray]]]:
        ...
        for count, uid in enumerate(uid_iter, 1):
            ...
            for value, (path, name, _type) in zip(values, self.path_name_type_list):
                ...
                # Load entry
                if _type == "video":
                    array=func(uid,value)
                elif _type == "video_no_interpolation":
                    array=func(value)
                else:
                    array = func(value)
                data[name] = array
            ...
            for name in data:
                ...
                if value.dtype.kind == "f":
                    ...
                    raise NotImplementedError(f"Not supported dtype:{name} {value} {value.dtype}")
                data[name] = value
