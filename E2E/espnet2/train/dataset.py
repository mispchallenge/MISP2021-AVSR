...
from espnet2.fileio.npy_scp import VideoScpReader
from espnet2.fileio.npy_scp import Video_nointerpolation_ScpReader
...
DATA_TYPES = {
    "video":dict(
        func=VideoScpReader,
        kwargs=[],
        help="self definite to load video frame in npz and change rate by uid"
        "\n\n"
        "   uid a.npz\n"
        "   uid b.npz\n"
        "   ...",
    ...
    "v_no_interpolation":dict(
        func=Video_nointerpolation_ScpReader,
        kwargs=[],
        help="self definite to load video frame in npz and change rate by uid"
        "\n\n"
        "   uid a.npz\n"
...
class ESPnetDataset(AbsDataset):
    ...
    def __init__(
        ...
        self.loader_dict = {}
        # {"video":loader1,"audio":loader2,"text":loader3}
        self.debug_info = {}
    ...
    #return uid,data->{"text":np,"audio":np,"video":np}
