...
from espnet2.main_funcs.collect_stats_only_shape import collect_stats_only_shape
...
class AbsTask(ABC):
    ...
    def get_parser(cls) -> config_argparse.ArgumentParser:
        ...
        group.add_argument(
            "--only_write_shape_file",
            type=str2bool,
            default=False,
            help='only write shape file except status',
        )
        group.add_argument(
    ...
    def main_worker(cls, args: argparse.Namespace):
        ...
        if args.dry_run:
            ...
            if len(args.valid_shape_file) != 0:
                ...
                valid_key_file = None
            if not args.only_write_shape_file:
                collect_func = collect_stats
            else:
                collect_func = collect_stats_only_shape
